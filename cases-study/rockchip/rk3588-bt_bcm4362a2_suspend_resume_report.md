# RK3588 BCM4362A2 Bluetooth suspend/resume 問題分析與修正說明
...
### 2.1 原本流程：brcm_patchram_plus1

#### 2.1.1 brcm_patchram_plus1 的定位
...
#### 2.1.2 brcm_patchram_plus1 不是完全不進 kernel
...
#### 2.2.3 關鍵步驟：HCIUARTSETPROTO -> HCI_UART_BCM
