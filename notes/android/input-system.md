...
## 10. Input threads 與 scheduler / cgroup / uclamp 的實際關係
...
### 10.1 Input pipeline 中的關鍵 threads
...
### 10.2 Input thread 的 cgroup 與 uclamp 定位
...
### 10.3 為什麼 input lag 常被誤判為 driver 問題
...
### 10.4 Input latency 的實戰 debug 路徑
